...
class InstantCharacterFluxPipeline(FluxPipeline):
    ...
    def init_ccp_and_attn_processor(self, *args, **kwargs):
        ...
        import logging
        logging.debug(f"=> init attn processor")
        attn_procs = {}
        ...
        logging.debug(f"=> load attn processor: {key_name}")

        logging.debug(f"=> init project")
        ...
        logging.debug(f"=> load project: {key_name}")
    ...
    def init_adapter(
        ...
        # image encoder
        logging.debug(f"=> loading image_encoder_1: {image_encoder_path}")
        ...
        # image encoder 2
        logging.debug(f"=> loading image_encoder_2: {image_encoder_2_path}")
